...
from django.utils.translation import ugettext_lazy as _                                              # what does " as _" mean?
from .models import *      # is "*" a module?
from .forms import *

# Inlines    


class pfCatalogFileTypeInline(admin.TabularInline):                                                  # 1. what's "class?"   
